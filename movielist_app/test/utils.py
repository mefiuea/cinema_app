...
from movielist_app.models import Person, Movie
...
def fake_movie_data():
    """Generate a dict of movie data. The format is compatible with serializers
    (`Person` relations represented by names)."""
    movie_data = {
